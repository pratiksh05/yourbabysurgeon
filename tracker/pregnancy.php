         ...
         <div class="row" style="background-color:#517a7f;">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
               <div class="mainHeading" align="left" style="font-size:50px">
                  <h1 align="center">Hanuman Chalisa & Pregnancy Tracker</h1>
               </div>
            </div>
                     ...
                     <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                        <thead>
                           <tr>
                              ...
                              <th class="alignTextToCenter">Husband Name</th>
                        ...
                        <tbody>
                           <?php
                                ...
                                $fetchRequests = "select name,husbandName,contactNumber,emailID,contactAddress,date from pregnancy where status = 1";
...

                                {
                                  ...
                                  echo '<td>' . $availableRequests['husbandName'] . '</td>';
                                  echo '<td>' . $availableRequests['emailID'] .'</td>';
                                  echo '<td>' . $availableRequests['contactNumber'] . '</td>';
                                  echo '<td>' . $availableRequests['contactAddress'] . '</td>';
